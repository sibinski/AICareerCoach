...
# Load API key from .env file and project id
load_dotenv()
...
cover_letter_app = gr.Interface(
    ...
    inputs=[
        ...
        #gr.Textbox(label="Job Skills Keywords", placeholder="Paste the job skills keywords here...", lines=2),
    ...
    description="Generate a customized cover letter by entering the company name, position name, job description, job skills, and your resume."
)
